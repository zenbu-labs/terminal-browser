...
class Session {
  ...
  private render() {
    ...
    // each tab paints into its own surface; binding the active tab's surface here is
    // what swaps the picture in the same engine frame as the rest of the tab switch
